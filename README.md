...
BladeWalker est un projet d'apprentissage par renforcement (**Reinforcement Learning, RL**) dont l'objectif est d'entraîner un agent bipède simulé à marcher le plus loin possible vers l'avant, uniquement en apprenant par essais et erreurs — sans règles explicites ni démonstrations humaines.
...
```bash
# 1. Cloner le projet
git clone https://github.com/r0n/BladeWalker.git
cd BladeWalker
